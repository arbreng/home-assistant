...
from homeassistant.components.climate import (
    ATTR_FAN_MODE, ATTR_SWING_MODE, PLATFORM_SCHEMA, STATE_DRY, STATE_FAN_ONLY,
    SUPPORT_FAN_MODE, SUPPORT_OPERATION_MODE, SUPPORT_SWING_MODE,
...
from homeassistant.const import (
    ATTR_CURRENT_TEMPERATURE, ATTR_OPERATION_MODE, ATTR_TEMPERATURE, CONF_HOST,
    CONF_NAME, STATE_AUTO, STATE_COOL, STATE_HEAT, STATE_OFF, TEMP_CELSIUS)
