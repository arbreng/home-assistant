...
from homeassistant.components.climate import (
    ...
    STATE_ECO, STATE_ELECTRIC, STATE_FAN_ONLY, STATE_GAS, STATE_HEAT_PUMP,
    STATE_HIGH_DEMAND, STATE_PERFORMANCE, SUPPORT_AUX_HEAT, SUPPORT_AWAY_MODE,
    SUPPORT_FAN_MODE, SUPPORT_OPERATION_MODE, SUPPORT_TARGET_TEMPERATURE,
    SUPPORT_TARGET_TEMPERATURE_HIGH, SUPPORT_TARGET_TEMPERATURE_LOW,
    ClimateDevice)
from homeassistant.components.wink import DOMAIN, WinkDevice
from homeassistant.const import (
    ATTR_TEMPERATURE, PRECISION_TENTHS, STATE_AUTO, STATE_COOL, STATE_HEAT,
