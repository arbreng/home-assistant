...
from homeassistant.components.climate import (
    ...
    SUPPORT_ON_OFF, STATE_DRY, STATE_FAN_ONLY, SUPPORT_FAN_MODE
)
from homeassistant.components.fan import SPEED_LOW, SPEED_MEDIUM, SPEED_HIGH
from homeassistant.components.melissa import DATA_MELISSA
from homeassistant.const import (
    TEMP_CELSIUS, STATE_ON, STATE_OFF, STATE_IDLE, STATE_AUTO, STATE_HEAT,
    STATE_COOL, ATTR_TEMPERATURE, PRECISION_WHOLE
)
