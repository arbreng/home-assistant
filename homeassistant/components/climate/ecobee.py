...
from homeassistant.components.climate import (
    ATTR_TARGET_TEMP_HIGH, ATTR_TARGET_TEMP_LOW, DOMAIN, SUPPORT_AUX_HEAT,
    SUPPORT_AWAY_MODE, SUPPORT_FAN_MODE, SUPPORT_HOLD_MODE,
    SUPPORT_OPERATION_MODE, SUPPORT_TARGET_HUMIDITY_HIGH,
    SUPPORT_TARGET_HUMIDITY_LOW, SUPPORT_TARGET_TEMPERATURE,
    SUPPORT_TARGET_TEMPERATURE_HIGH, SUPPORT_TARGET_TEMPERATURE_LOW,
    ClimateDevice)
from homeassistant.const import (
    ATTR_ENTITY_ID, ATTR_TEMPERATURE, STATE_AUTO, STATE_COOL, STATE_HEAT,
    STATE_IDLE, STATE_OFF, STATE_ON, TEMP_FAHRENHEIT)
