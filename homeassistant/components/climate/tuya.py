...
from homeassistant.components.climate import (
    ENTITY_ID_FORMAT, STATE_ECO, STATE_ELECTRIC, STATE_FAN_ONLY, STATE_GAS,
    STATE_HEAT_PUMP, STATE_HIGH_DEMAND, STATE_PERFORMANCE, SUPPORT_FAN_MODE,
...
from homeassistant.const import (
    ATTR_TEMPERATURE, PRECISION_WHOLE, STATE_AUTO, STATE_COOL, STATE_HEAT,
