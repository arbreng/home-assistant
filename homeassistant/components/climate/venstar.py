...
from homeassistant.components.climate import (
    ATTR_TARGET_TEMP_HIGH, ATTR_TARGET_TEMP_LOW, PLATFORM_SCHEMA,
...
from homeassistant.const import (
    ATTR_OPERATION_MODE, ATTR_TEMPERATURE, CONF_HOST, CONF_PASSWORD, CONF_SSL,
    CONF_TIMEOUT, CONF_USERNAME, PRECISION_WHOLE, STATE_AUTO, STATE_COOL,
    STATE_HEAT, STATE_OFF, STATE_ON, TEMP_CELSIUS, TEMP_FAHRENHEIT)
