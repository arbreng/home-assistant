...
from homeassistant.components.climate import (
    ...
    ATTR_HUMIDITY, ATTR_OPERATION_MODE, ATTR_SWING_MODE, SERVICE_SET_AUX_HEAT,
    SERVICE_SET_AWAY_MODE, SERVICE_SET_FAN_MODE, SERVICE_SET_HOLD_MODE,
...
from homeassistant.components.climate.ecobee import (
    ATTR_FAN_MIN_ON_TIME, ATTR_RESUME_ALL, SERVICE_RESUME_PROGRAM,
    SERVICE_SET_FAN_MIN_ON_TIME)
from homeassistant.components.cover import ATTR_POSITION, ATTR_TILT_POSITION
from homeassistant.components.media_player import (
    ATTR_INPUT_SOURCE, ATTR_MEDIA_CONTENT_ID, ATTR_MEDIA_CONTENT_TYPE,
    ATTR_MEDIA_SEEK_POSITION, ATTR_MEDIA_VOLUME_LEVEL, ATTR_MEDIA_VOLUME_MUTED,
...
from homeassistant.const import (
    ...
    SERVICE_CLOSE_COVER, SERVICE_LOCK, SERVICE_MEDIA_PAUSE, SERVICE_MEDIA_PLAY,
    SERVICE_MEDIA_SEEK, SERVICE_MEDIA_STOP, SERVICE_OPEN_COVER,
    SERVICE_SELECT_OPTION, SERVICE_SET_COVER_POSITION,
    SERVICE_SET_COVER_TILT_POSITION, SERVICE_SET_TEMPERATURE, SERVICE_TURN_OFF,
    SERVICE_TURN_ON, SERVICE_UNLOCK, SERVICE_VOLUME_MUTE, SERVICE_VOLUME_SET,
    STATE_ALARM_ARMED_AWAY, STATE_ALARM_ARMED_HOME, STATE_ALARM_DISARMED,
    STATE_ALARM_TRIGGERED, STATE_CLOSED, STATE_COOL, STATE_HEAT, STATE_HOME,
    STATE_IDLE, STATE_LOCKED, STATE_NOT_HOME, STATE_OFF, STATE_ON, STATE_OPEN,
