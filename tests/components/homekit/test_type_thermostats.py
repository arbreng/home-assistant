...
from homeassistant.components.climate import (
    ATTR_OPERATION_LIST, ATTR_TARGET_TEMP_HIGH, ATTR_TARGET_TEMP_LOW,
    DEFAULT_MAX_TEMP, DEFAULT_MIN_TEMP, DOMAIN)
from homeassistant.components.homekit.const import (
    PROP_MAX_VALUE, PROP_MIN_VALUE)
from homeassistant.const import (
    ATTR_CURRENT_TEMPERATURE, ATTR_ENTITY_ID, ATTR_MAX_TEMP, ATTR_MIN_TEMP,
    ATTR_OPERATION_MODE, ATTR_SUPPORTED_FEATURES, ATTR_TEMPERATURE,
    ATTR_UNIT_OF_MEASUREMENT, CONF_TEMPERATURE_UNIT, STATE_AUTO, STATE_COOL,
    STATE_HEAT, STATE_OFF, TEMP_CELSIUS, TEMP_FAHRENHEIT)
